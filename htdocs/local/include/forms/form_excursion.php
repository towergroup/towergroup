...
<div class="modal-broker-form">
    ...
    <form class="form" id="excursion-form"><input type="hidden" id="excursion-broker-name" name="excursion-broker-name" value="<?= $GLOBALS['default_broker']['NAME']?>">
        <input type="hidden" name="form_name" value="<?= htmlspecialcharsBack($arInfo["TITLE"]); ?>">
