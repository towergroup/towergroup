...
<form name="<?=$arResult["WEB_FORM_NAME"]?>" action="<?=POST_FORM_ACTION_URI?>" method="POST" enctype="multipart/form-data" class="form" novalidate="novalidate">
...
<? foreach ($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion): ?>
    ...
    elseif ($arQuestion['STRUCTURE'][0]['FIELD_TYPE'] == 'checkbox'): ?>
        <div class="form-control">
            <button type="submit" name="web_form_submit" disabled="disabled" id="button-form-feedback"
        ...
        <div class="form-item form-item--checkbox form-unlock">
            <label class="checkbox">
                <input type="checkbox" checked id="8" name="form_checkbox_POLITICS[]" value="8">
