    ...
    protected function exec()
    {
        ...
        if (!empty($cityCode) && !empty($objectCode)) { // Страница объекта
            ...
            if (!empty($arFlat)) {
                ...
                $arFlat["SQUARE_CURRENCY"] = "м²";
                if ($arFlat["PROPERTY_TYPE_FLATS_VALUE"] == 'Участок') {
                    $arFlat["PROPERTY_SQUARE_VALUE"] = floatval($arFlat["PROPERTY_SQUARE_VALUE"]) / 100;
                    $arFlat["SQUARE_CURRENCY"] = str_replace($arFlat["PROPERTY_SQUARE_VALUE"],"",plural_form($arFlat["PROPERTY_SQUARE_VALUE"], array("сотка", "сотки", "соток")));
                }
                ...
                foreach ($rsSeoTemplate["PROPERTY_VARIABLES_DESCRIPTION"] as $keySeoProperty => $valSeoProperty) {
                    ...
                    elseif ($valSeoProperty == "PROPERTY_SQUARE_ACRES_VALUE") {
                        $rsSeoTemplate["PROPERTY_VARIABLES_REPLACE"][$keySeoProperty] = plural_form($arFlat["PROPERTY_SQUARE_ACRES_VALUE"], array("сотка", "сотки", "соток"));
                    }
                ...
                if (!empty($arObject['FLAT']['PROPERTY_SIMILAR_FLATS_VALUE'])) {
                    ...
                    while ($rsSimilarObject = $rsSimilarObjects->GetNext()){
                        ...
                        $rsSimilarObject["SQUARE_CURRENCY"] = "м²";
                        if ($rsSimilarObject["PROPERTY_TYPE_FLATS_VALUE"] == 6) {
                            ...
                            $rsSimilarObject["SQUARE_CURRENCY"] = str_replace($rsSimilarObject["PROPERTY_SQUARE_VALUE"],"",plural_form($rsSimilarObject["PROPERTY_SQUARE_VALUE"], array("сотка", "сотки", "соток")));
                        }
...
//            $sortBy   = ($_GET['sortBy'] && $_GET['sortBy'] != 'default')? $_GET['sortBy'] : $this->arParams["SORT_BY_DEFAULT"];
            ...
            $arFilterRanges['SQUARE_CURRENCY'] = "м²";
            ...
            if ($convertSquare) {
                ...
                $arFilterRanges['SQUARE_CURRENCY'] = "соток";
            }
            ...
            while ($arObjectApartment = $rsObjectApartment->Fetch()) {
                $arObjectApartment["SQUARE_CURRENCY"] = "м²";
                ...
                if ($arObjectApartment["PROPERTY_TYPE_FLATS_VALUE"] == 6) {
                    ...
                    $arObjectApartment["SQUARE_CURRENCY"] = str_replace($arObjectApartment["PROPERTY_SQUARE_VALUE"],"",plural_form($arObjectApartment["PROPERTY_SQUARE_VALUE"], array("сотка", "сотки", "соток")));
                }
