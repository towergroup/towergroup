...
$APPLICATION->SetPageProperty("description", "Выбор загородной недвижимости Tower Group.");
$APPLICATION->SetPageProperty("page", "catalog_country");
$APPLICATION->SetPageProperty("body-page", $_GET['showMap'] == 'Y' ? "class='-catalog-map'" : "class='-catalog-list'");
$this->addExternalCss(SITE_TEMPLATE_PATH . "/css/catalog_country.min.css");
    ...
    <div class="container">
        <form class="catalog-filter" data-filter-tags="data-filter-tags">
            <div class="catalog-filter-title">
                <div class="h2">Фильтры</div><button data-catalog-filter-close="data-catalog-filter-close" type="button"><svg class="icon icon--cross-light-large" width="32" height="32" viewbox="0 0 32 32">
                    ...
                    <div class="catalog-filter-hero">
                        <div class="catalog-filter-fields">
                            ...
                            <div class="catalog-filter-item catalog-filter-item--search">
                                <div class="dropdown dropdown--search" id="filter-search" data-search-line="data-search-line" data-search-line-url="/ajax/search_dom_<?=$arParams['CITY_CODE'];?>.php">
                            ...
                            <?if (!empty($arResult["BUILDING_TYPES"])) :?>
                                <div class="catalog-filter-item">
                                    <div class="dropdown dropdown--checkbox" id="filter-property-type" data-dropdown="checkbox">
                                        ...
                                        <div class="field-input">Тип недвижимости</div>
                            ...
                            <?if ($arResult["FILTER_RANGES"]["MIN_SQUARE"] != $arResult["FILTER_RANGES"]["MAX_SQUARE"]): ?>
                                <div class="catalog-filter-item">
                                    <div class="catalog-filter-item-label filter-square">Площадь</div>
                                    <?
                                    if ($arResult['IS_AJAX'] && $arResult['SQUARE_CONVERT'])
                                        $APPLICATION->RestartBuffer();
                                    ?>
                                    <?
                                    if ($arResult["FILTER_RANGES"]["SQUARE_CURRENCY"] == "м²") {
                                        $curSquareCurrencyMin = $arResult["FILTER_RANGES"]["SQUARE_CURRENCY"];
                                        $curSquareCurrencyMax = $arResult["FILTER_RANGES"]["SQUARE_CURRENCY"];
                                    }
                                    else {
                                        $curSquareCurrencyMin = str_replace($arResult["FILTER_RANGES"]["MIN_SQUARE"],"",plural_form($arResult["FILTER_RANGES"]["MIN_SQUARE"],array("соток", "соток", "соток")));
                                        $curSquareCurrencyMax = str_replace($arResult["FILTER_RANGES"]["MAX_SQUARE"],"",plural_form($arResult["FILTER_RANGES"]["MAX_SQUARE"],array("соток", "соток", "соток")));
                                    }
                                    ?>
                                    <div class="dropdown dropdown--radio" id="filter-size" data-dropdown="range-select" data-dropdown-min="<?= $arResult["FILTER_RANGES"]["MIN_SQUARE"]; ?>" data-dropdown-max="<?= $arResult["FILTER_RANGES"]["MAX_SQUARE"]; ?>" data-dropdown-prefix-label="Площадь" data-dropdown-prefix-form="от" data-dropdown-prefix-to="до" data-dropdown-postfix="<?= $arResult["FILTER_RANGES"]["SQUARE_CURRENCY"]; ?>">
                                            ...
                                            <div class="dropdown-values-range-select">
                                                <div class="dropdown-values-range-select-item" data-dropdown-from="data-dropdown-from">
                                                    <div class="dropdown-values-range-select-label">
                                                        <div class="field-input" data-dropdown-label="data-dropdown-label">от<div>,</div> <span data-dropdown-empty-default="<?= $arResult["FILTER_RANGES"]["MIN_SQUARE"]; ?>"><?= $arResult["FILTER_RANGES"]["MIN_SQUARE"]; ?></span> <?= $curSquareCurrencyMin; ?></div><input class="field-input" type="number" value="<?= ($arResult["FILTER_VALUES"]["SQUARE"][0])? $arResult["FILTER_VALUES"]["SQUARE"][0] : null?>" data-dropdown-value="data-dropdown-value">
                                                    </div>
                                                </div>
                                                <div class="dropdown-values-range-select-item" data-dropdown-to="data-dropdown-to">
                                                    <div class="dropdown-values-range-select-label">
                                                        <div class="field-input" data-dropdown-label="data-dropdown-label">до<div>,</div> <span data-dropdown-empty-default="<?= $arResult["FILTER_RANGES"]["MAX_SQUARE"]; ?>"><?= $arResult["FILTER_RANGES"]["MAX_SQUARE"]; ?></span> <?= $curSquareCurrencyMax; ?></div><input class="field-input" type="number" value="<?= ($arResult["FILTER_VALUES"]["SQUARE"][1])? $arResult["FILTER_VALUES"]["SQUARE"][1] : null?>" data-dropdown-value="data-dropdown-value">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="catalog-filter-other">
                        ...
                        <?if (!empty($arResult["APARTMENT_TYPES"])) :?>
                            <div class="catalog-filter-item">
                                <div class="dropdown dropdown--checkbox" id="filter-apartment-type" data-dropdown="checkbox">
                                    ...
                                    <div class="field-input">Количество спален</div>
                                    <div class="dropdown-icon"><svg class="icon icon--dropdown" width="10" height="6" viewbox="0 0 10 6">
                                            <use xlink:href="#dropdown" />
                                        </svg></div>
                                    <div class="dropdown-values">
                        ...
                        <div class="catalog-filter-item catalog-filter-item--links">
                            <div class="dropdown dropdown--link" data-dropdown="link">
                                <div class="field-input field-input--center">
                                    <div class="field-input-inside"><span>Загородная</span>
                                        <div class="dropdown-icon"><svg class="icon icon--dropdown" width="10" height="6" viewbox="0 0 10 6">
                                                <use xlink:href="#dropdown" />
                                            </svg></div>
                                    </div>
                                ...
                                <div class="dropdown-values">
                                    <ul class="list">
                                        <li class="list-item list-item--active"><span class="list-link">Загородная</span></li>
                                            ...
                                            <div class="object-other-info">
                                                ...
                                                <div class="object-other-data">
                                                    <? if (!empty($arObject['PROPERTY_SQUARE_VALUE'])): ?>
                                                        <span><?if($arObject['PROPERTY_PRICE_FROM_VALUE'] === "Да"):?>от<?endif;?> <?= $arObject['PROPERTY_SQUARE_VALUE']; ?> <?= $arObject["SQUARE_CURRENCY"]; ?></span>
                                                    <? endif; ?>
                                                ...
                                                <? if (!empty($arObject['PROPERTY_PRICE_RUB_VALUE'])): ?>
                                                    <div class="object-other-price">
                                                        <?if($arObject['PROPERTY_PRICE_FROM_VALUE'] === "Да"):?>от<?endif;?> <?= number_format($arObject['PROPERTY_PRICE_RUB_VALUE'], 0, ',', ' '); ?> ₽
                                                    </div>
                                                <? endif; ?>
                                            </div>
                                        </a>
                                    ...
                                    <script>
                                        ...
                                        $itemMap['options'] = [
                                            (!empty($arObject["PROPERTY_SQUARE_VALUE"])) ?
                                                $arObject["PROPERTY_SQUARE_VALUE"].' '.$arObject["SQUARE_CURRENCY"] : "",
                ...
                <div class="container">
                    <div class="catalog-about">
                        <div class="catalog-about-title">
                            <h2 class="h1"><?= $arResult['SEO']['PROPERTY_H_COUNTRY_VALUE']?></h2>
                        </div>
                        <div class="catalog-about-text">
                            <?= $arResult['SEO']['~PROPERTY_DESC_COUNTRY_VALUE']['TEXT']; ?>
                        </div>
                    </div>
                </div>
            </section>
    ...
    $(function () {
        function checkFilterParams() {
            ...
            if (squareMin || squareMax)
                var squareCurrency = jQuery('#filter-size').attr('data-dropdown-postfix');
            ...
            if (squareCurrency) params.squarecurrency = squareCurrency;
            //console.log(params);
            return params;
        }
        ...
        function getCountConvert(event = null) {
            var event = event.target || event;
            var params = checkFilterParams();

            params.getCountConvert = true;
            ...
            jQuery.ajax({
                ...
                success: function (html) {
                    jQuery('#filter-size').remove();
                    jQuery('.filter-square').after(html);
                    //dropDownUpdate('#filter-size');
                    /*jQuery('#apply-filter > span').text(count);
                     if (count > 0 ) {
                     jQuery('#apply-filter').removeAttr('disabled');
                     }
                    ...
                    jQuery('#filter-size').on('change', function () {
                        getCount(this);
                    });
                }
            });
        ...
        function getObjects(count) {
                ...
                success: function (html) {
                    ...
                    if (html) {
                        ...
                        if (jQuery('.catalog-empty.params-noresult')){
                            ...
                            jQuery('.params-content').html($(html).html());
                        }
                        else {
            ...
            var url = '/<?= $arResult['CITY']; ?>/kupit-dom/' + queryParams;
            location.href = url;
        ...
        $('.catalog-filter').on('click', '#filter-property-type [data-dropdown-id]', function (e) {
            e.preventDefault();
            setTimeout(function(){
                getCountConvert(e);
            }, 500);
        ...
        jQuery(document).on('click', '#sort [data-dropdown-id]', function (e) {
            e.preventDefault();
            setTimeout(function(){
                getObjects();
            }, 300);
        ...
        jQuery(document).on('click', '#filter-clear', function (e) {
            e.preventDefault();
            var url = '/<?=$arParams['CITY_CODE'];?>/kupit-dom/';
            location.href = url;
        });
    });
</script>