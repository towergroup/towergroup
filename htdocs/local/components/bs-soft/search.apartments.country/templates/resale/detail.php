...
$APPLICATION->SetPageProperty("page", 'detail_resale');
$APPLICATION->SetPageProperty("body-page", "class='-detail-page'");
$this->addExternalCss(SITE_TEMPLATE_PATH . "/css/detail_resale.min.css");
...
if (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])){
    ...
    if ($urlPieces[0] === $_SERVER['HTTP_HOST']) {
        ...
        $backUrl = SITE_ID == s2 ? "/spb/kupit-dom/" : "/moskva/kupit-dom/";
...
if(!empty($arResult["OBJECT"]["CONTACT"]["PROPERTY_PHONE_COUNTRY_VALUE"])) {
    $phoneValue = $arResult["OBJECT"]["CONTACT"]["PROPERTY_PHONE_COUNTRY_VALUE"];
} else {
            ...
            <div class="detail-heading-navigation">
                <ul class="list">
                    ...
                    <? if(!empty($arResult['OBJECT']["FLAT"]["PROPERTY_MAP_VALUE"])): ?>
                        <li class="list-item"><a class="list-link" href="#infrastructure" data-scroll-to="data-scroll-to">Инфраструктура</a></li>
                    <? endif; ?>
                </ul>
            </div>
            ...
            <div class="detail-hero-other-info" data-scroll-fx>
                ...
                <div class="detail-hero-other-params">
                    <?if (!empty($arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"])): ?>
                        <span><?if($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_FROM_VALUE"] === "Да"):?>от<?endif;?> <?= $arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"]; ?> <?= $arResult["OBJECT"]["FLAT"]["SQUARE_CURRENCY"]; ?></span>
                    <?endif;?>
                    ...
                    <?if (!empty($arResult["OBJECT"]["FLAT"]["PROPERTY_FLOOR_MAX_VALUE"])): ?>
                        <span><?= plural_form($arResult["OBJECT"]["FLAT"]["PROPERTY_FLOOR_MAX_VALUE"], array("этаж","этажа","этажей")); ?></span>
                    <?endif;?>
                </div>
                <div class="detail-hero-other-price">
                    <?if (!empty($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_RUB_VALUE"])): ?>
                        <div class="detail-hero-other-price-value" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                            ...
                            <?if (!empty($arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"])):?>
                                <?$squareCurrency = ($arResult["OBJECT"]["FLAT"]["SQUARE_CURRENCY"] == 'м²') ? 'м²': 'сотку'; ?>
                                <div class="detail-hero-other-price-small"
                                     data-sq-rur="<?if($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_FROM_VALUE"] === "Да"):?>от<?endif;?> <?= number_format($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_RUB_VALUE"] / $arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"], 0, '.', ' ') ?> ₽/<?= $squareCurrency; ?>"
                                     data-sq-usd="<?if($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_FROM_VALUE"] === "Да"):?>от<?endif;?> <?= number_format($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_USD_VALUE"] / $arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"], 0, '.', ' ') ?> USD/<?= $squareCurrency; ?>"
                                     data-sq-eur="<?if($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_FROM_VALUE"] === "Да"):?>от<?endif;?> <?= number_format($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_EUR_VALUE"] / $arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"], 0, '.', ' ') ?> EUR/<?= $squareCurrency; ?>">
                ...
                <ul class="list">
                    ...
                    <? if($arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"]): ?>
                        <li class="list-item">
                            ...
                            <div class="list-item-value"><?= $arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"]; ?> <?= $arResult["OBJECT"]["FLAT"]["SQUARE_CURRENCY"]; ?></div>
                        </li>
                    <? endif; ?>
                    ...
                    <? endif; ?>
                    <? if($arResult["OBJECT"]["FLAT"]["PROPERTY_FLOOR_MAX_VALUE"]): ?>
                        <li class="list-item">
                            <div class="list-item-label"><?= str_replace($arResult["OBJECT"]["FLAT"]["PROPERTY_FLOOR_MAX_VALUE"],"",plural_form($arResult["OBJECT"]["FLAT"]["PROPERTY_FLOOR_MAX_VALUE"], array("Этаж","Этажа","Этажей"))); ?></div>
                            <div class="list-item-value"><?= $arResult["OBJECT"]["FLAT"]["PROPERTY_FLOOR_MAX_VALUE"]; ?></div>
                        </li>
                    <? endif; ?>
                        ...
                        <div class="catalog-item">
                            <a class="object-other" href="<?= $object['SECTION_PAGE_URL']; ?>">
                                ...
                                <div class="object-other-info">
                                    <h4><?= $object['NAME']; ?></h4>
                                    <div class="object-other-data"><span><?if($object["PROPERTY_PRICE_RUB_VALUE"] === "Да"):?>от<?endif;?> <?= $object['PROPERTY_SQUARE_VALUE']; ?> <?= $object["SQUARE_CURRENCY"]; ?></span><span><?= $object['PROPERTY_ROOMS_NUMBER_VALUE']; ?> комнаты</span><span><?= $object['PROPERTY_DECORATION_VALUE'] ? $object['PROPERTY_DECORATION_VALUE'] : 'Без отделки'; ?></span></div>
                                    <div class="object-other-price"><?if($object["PROPERTY_PRICE_RUB_VALUE"] === "Да"):?>от<?endif;?> <?=number_format($object["PROPERTY_PRICE_RUB_VALUE"], 0, '.', ' ')?> ₽</div>
                                </div>
                            </a>
                        </div>
                    <? endforeach; ?>
