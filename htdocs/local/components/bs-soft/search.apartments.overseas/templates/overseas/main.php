...
$APPLICATION->SetPageProperty("description", "Выбор зарубежной недвижимости Tower Group.");
$APPLICATION->SetPageProperty("page", "catalog_overseas");
$APPLICATION->SetPageProperty("body-page", $_GET['showMap'] == 'Y' ? "class='-catalog-map'" : "class='-catalog-list'");
$this->addExternalCss(SITE_TEMPLATE_PATH . "/css/catalog_overseas.min.css");
$banner = 0;
...
$GLOBALS['default_broker'] = array(
    ...
    "TYPE_OF_PROPERTY" => "Зарубежная"
);

$url = "https://towergroup.ru/moskva/nedvizhimost-za-rubezhom/";
if (SITE_ID == "s2") {
    $APPLICATION->AddHeadString('<link href="'.$url.'" rel="canonical" />',true);
}
//xprint($arResult["OBJECTS"]["ITEMS"]);
?>
<script>
    window.mapOptions = {
                    ...
                    <div class="catalog-filter-hero">
                        <div class="catalog-filter-fields">
                            ...
                            <div class="catalog-filter-item catalog-filter-item--search">
                                <div class="dropdown dropdown--search" id="filter-search" data-search-line="data-search-line" data-search-line-url="/ajax/search_overseas.php">
                                    ...
                                    <div class="field field--search"><input class="field-input" type="text" data-placeholder-long="Начните вводить страну, регион, город, адрес" data-placeholder-short="Страна, регион, город, адрес" placeholder="Страна, регион, город, адрес" data-search-line-input="data-search-line-input"><button class="field-search-clear" type="button" data-search-line-clear="data-search-line-clear"><svg class="icon icon--cross-light" width="16" height="16" viewbox="0 0 16 16">
                            ...
                            <?if (!empty($arResult["CITIES"])) :?>
                                <div class="catalog-filter-item">
                                    <div class="dropdown dropdown--radio" id="filter-city" data-dropdown="radio" data-dropdown-tags="data-dropdown-tags"><input type="hidden" value="<?= ($_GET["city"]) ? $_GET["city"]: null; ?>" data-dropdown-value="data-dropdown-value">
                    ...
                    <div class="catalog-filter-other">
                        ...
                        <div class="catalog-filter-item catalog-filter-item--links">
                            <div class="dropdown dropdown--link" data-dropdown="link">
                                <div class="field-input field-input--center">
                                    <div class="field-input-inside"><span>Зарубежная</span>
                                ...
                                <div class="dropdown-values">
                                    <ul class="list">
                                        <li class="list-item list-item--active"><span class="list-link">Зарубежная</span></li>
                                            ...
                                            <div class="object-other-info">
                                                ...
                                                <div class="object-other-data">
                                                    <? if (!empty($arObject['PROPERTY_SQUARE_VALUE'])): ?>
                                                        <span><?if($arObject['PROPERTY_PRICE_FROM_VALUE'] === "Да"):?>от<?endif;?> <?= $arObject['PROPERTY_SQUARE_VALUE']; ?> м²</span>
                                                    <? endif; ?>
                                                ...
                                                <? if (!empty($arObject['PROPERTY_PRICE_RUB_VALUE'])): ?>
                                                    <div class="object-other-price">
                                                        <?if($arObject['PROPERTY_PRICE_FROM_VALUE'] === "Да"):?>от<?endif;?>
                ...
                <div class="container">
                    <div class="catalog-about">
                        <div class="catalog-about-title">
                            <h2 class="h1"><?= $arResult['SEO']['PROPERTY_H_OVERSEAS_VALUE']?></h2>
                        </div>
                        <div class="catalog-about-text">
                            <?= $arResult['SEO']['~PROPERTY_DESC_OVERSEAS_VALUE']['TEXT']?>
                        </div>
                    </div>
                </div>
            </section>
...
<script>
    $(function () {
        ...
        function getObjects(count) {
            ...
            var url = '/<?= $arResult['CITY']; ?>/nedvizhimost-za-rubezhom/' + queryParams;
            location.href = url;
        ...
        jQuery(document).on('click', '#filter-clear', function (e) {
            e.preventDefault();
            var url = '/<?=$arParams['CITY_CODE'];?>/nedvizhimost-za-rubezhom/';
            location.href = url;
        });
    });
</script>