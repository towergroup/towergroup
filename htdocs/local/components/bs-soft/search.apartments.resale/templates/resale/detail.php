...
if (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])){
    ...
    if ($urlPieces[0] === $_SERVER['HTTP_HOST']) {
        ...
        $backUrl = SITE_ID == s2 ? "/spb/kupit-kvartiru/" : "/moskva/kupit-kvartiru/";
...
if(!empty($arResult["OBJECT"]["CONTACT"]["PROPERTY_PHONE_RESALE_VALUE"])) {
    $phoneValue = $arResult["OBJECT"]["CONTACT"]["PROPERTY_PHONE_RESALE_VALUE"];
} else {
            ...
            <div class="detail-hero-other-info" data-scroll-fx>
                ...
                <div class="detail-hero-other-params">
                    <?if (!empty($arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"])): ?>
                        <span><?= $arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"]; ?> м²</span>
                    <?endif;?>
                    ...
                    <?if (!empty($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_RUB_VALUE"])): ?>
                        <div class="detail-hero-other-price-value" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                            ...
                            <div class="detail-hero-other-price-large"
                                 data-price-rur="<?= number_format($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_RUB_VALUE"], 0, '.', ' ') ?> ₽"
                                 data-price-usd="<?= number_format($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_USD_VALUE"], 0, '.', ' ') ?> USD"
                                 data-price-eur="<?= number_format($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_EUR_VALUE"], 0, '.', ' ') ?> EUR">
                                <?= number_format($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_RUB_VALUE"], 0, '.', ' ') ?> ₽
                            </div>
                            <?if (!empty($arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"])):?>
                                <div class="detail-hero-other-price-small"
                                     data-sq-rur="<?= number_format($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_RUB_VALUE"] / $arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"], 0, '.', ' ') ?> ₽/м²"
                                     data-sq-usd="<?= number_format($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_USD_VALUE"] / $arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"], 0, '.', ' ') ?> USD/м²"
                                     data-sq-eur="<?= number_format($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_EUR_VALUE"] / $arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"], 0, '.', ' ') ?> EUR/м²">
                                    <?= number_format($arResult["OBJECT"]["FLAT"]["PROPERTY_PRICE_RUB_VALUE"] / $arResult["OBJECT"]["FLAT"]["PROPERTY_SQUARE_VALUE"], 0, '.', ' ') ?>
                                    ₽/м²
                                </div>
                            <?endif;?>
                        </div>
                        ...
                        <div class="catalog-item">
                            <a class="object-other" href="<?= $object['SECTION_PAGE_URL']; ?>">
                                ...
                                <div class="object-other-info">
                                    <h4><?= $object['NAME']; ?></h4>
                                    <div class="object-other-data"><span><?= $object['PROPERTY_SQUARE_VALUE']; ?> м²</span><span><?= $object['PROPERTY_ROOMS_NUMBER_VALUE']; ?> комнаты</span><span><?= $object['PROPERTY_DECORATION_VALUE'] ? $object['PROPERTY_DECORATION_VALUE'] : 'Без отделки'; ?></span></div>
                                    <div class="object-other-price"><?=number_format($object["PROPERTY_PRICE_RUB_VALUE"], 0, '.', ' ')?> ₽</div>
                                </div>
                            </a>
                        </div>
                    <? endforeach; ?>
